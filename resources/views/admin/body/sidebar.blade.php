    ...
    <div class="sidebar-wrapper" data-simplebar="true">
        <div class="sidebar-header">
            <div>
                ...
                <img src="{{ asset('backend/images/standard-log.png') }}" class="logo-icon" alt="logo icon">
            </div>
            <div>
                <h4 class="logo-text">EOS</h4>
            </div>
        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                ...
                {{-- <li>
                    <a href="{{ route('manage_exam') }}">
                        <div class="parent-icon"><i class='bx bx-cookie'></i>
                        </div>
                        <div class="menu-title">Manage Exams</div>
                    </a>
                </li> --}}
                ...
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Manage Exam</div>
                    </a>
                    <ul>
                        <li> <a href="{{ route('manage_exam') }}"><i class="bx bx-right-arrow-alt"></i>Add Exam</a>
                        </li>
                        <li> <a href="{{ route('add_question') }}"><i class="bx bx-right-arrow-alt"></i>Add Question</a>
                        </li>
                ...
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Manage Examinee</div>
                    </a>
                    <ul>
                        <li> <a href="{{ route('manage_examinee') }}"><i class="bx bx-right-arrow-alt"></i>Add Examinee</a>
                        </li>
                        <li> <a href="{{ route('assign_examinee') }}"><i class="bx bx-right-arrow-alt"></i>Assign Examinee</a>
                        </li>
