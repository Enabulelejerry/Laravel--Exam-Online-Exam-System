     ...
     <div class="page-content">
              ...
              <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
                ...
                <?php
                 ...
                 ?>
                <div class="col">
                    <div class="card radius-10 <?php echo $cls ?>">
                     <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-white">{{ $exam->title }}</h5>
                            {{-- <div class="ms-auto">
                        ...
                        <div class="d-flex align-items-center text-white">
                            <p class="mb-0">{{  $exam->cat_name }}</p>
                            @if (strtotime(date('Y-m-d'))<strtotime($exam['exam_date']))
                            <a style="color:white" href="{{ url('portal/exam_form/'.$exam['id']) }}" class="mb-0 ms-auto">More Info<span><i class='bx bx-up-arrow-alt'></i></span></a>
                            @endif
