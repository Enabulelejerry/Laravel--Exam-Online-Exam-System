			...
			<div class="container-fluid">
				<div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
					<div class="col mx-auto">
						<h3 class="text-center">SLO Exam Portal</h3>
						<div class="card">
							<div class="card-body">
								<div class="border p-4 rounded">
									
							
									<div class="login-separater text-center mb-4"> <span>Portal Login</span>
										<hr/>
									</div>
									...
									<div class="form-body">
										<form method="POST" action="{{ route('pot_login') }}">
											@csrf
											<div class="col-12">
